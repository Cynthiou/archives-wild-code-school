...
```spacer-small
```
![Logo de GitHub](images/001-logo-de-github.png)
...
4. Clique sur "Create an account" (Créer un compte).
...
![Capture d'écran annotée permettant d'identifier les 5 zones décrite ci dessous sur le dashboard github](images/002-capture-d-ecran-annotee-permettant-d-identifier.png)
...
![Capture d'écran annotée permettant d'identifier les 7 zones décrites ci dessous sur la page de gestion d'un dépôt github](images/003-capture-d-ecran-annotee-permettant-d-identifier.png)
...
- Utilise le bouton **Add file** pour créer un fichier nommé `solution.txt`. Assure-toi qu'il contient au moins la phrase suivante : _Prêt·e pour ma formation à la Wild Code School_ . Et quand tu sauvegardes le fichier, n'oublie pas d'ajouter un commentaire explicite dans le **commit** ! 
