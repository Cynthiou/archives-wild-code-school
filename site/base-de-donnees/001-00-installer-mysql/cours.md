...
![dumbledore welcome](images/001-dumbledore-welcome.jpg)
...
![](images/002-installation-de-mysql-mac-os.jpg)
...
![](images/003-installation-de-mysql-mac-os.jpg)
...
![](images/004-installation-de-mysql-mac-os.jpg)
...
![Page de téléchargement MySQL](images/005-page-de-telechargement-mysql.jpg)
...
![Installation MySQL - Page d'accueil](images/006-installation-mysql-page-d-accueil.jpg)
...
![Installation MySQL - Téléchargement MySQL](images/007-installation-mysql-telechargement-mysql.jpg)

Lorsque le téléchargement de MySQL est terminé, clique sur **Next** puis **Execute**.

![Installation MySQL - MySQL installé](images/008-installation-mysql-mysql-installe.jpg)
...
![Installation MySQL - Configuration](images/009-installation-mysql-configuration.jpg)
...
![Installation MySQL - Mot de passe](images/010-installation-mysql-mot-de-passe.jpg)
...
![Installation MySQL - Configuration terminée](images/011-installation-mysql-configuration-terminee.jpg)
...
![MySQL Command Line Client](images/012-mysql-command-line-client.jpg)
...
![Enfin fini ! ](images/013-enfin-fini.jpg)
...
![Capture d'écran des variables d'environnement](images/014-capture-d-ecran-des-variables-d-environnement.png)
...
![capture help mysql](images/015-capture-help-mysql.png)
