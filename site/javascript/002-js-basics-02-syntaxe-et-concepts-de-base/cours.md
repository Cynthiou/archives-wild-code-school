...
![JS console Chrome](images/002-js-console-chrome.gif)
...
![Firefox console Js](images/003-firefox-console-js.gif)
```
...
![Hello World console](images/005-hello-world-console.png)
...
![Error js console](images/006-error-js-console.png)Tu peux voir que la console me dit `console.loge is not a function`.
...
![Writing](images/007-writing.png)
...
![Mathematic board](images/008-mathematic-board.png)
**Addition:**
...
![Apple comparison](images/009-apple-comparison.png)
...
![identation](images/010-identation.png)
