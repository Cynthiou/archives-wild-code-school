...
![Vérification d'un champ obligatoire grâce à l'attribut required d'un input](images/001-verification-d-un-champ-obligatoire-grace-a-l.png)
...
![Vérification grâce au type email d'un input](images/002-verification-grace-au-type-email-d-un-input.png)
...
![Utilisation de l'attribut pattern dans un champ input](images/003-utilisation-de-l-attribut-pattern-dans-un-champ.png)
