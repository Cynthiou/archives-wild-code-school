Un objet, c'est quoi ?
Un objet c'est… un mélange de plusieurs variables et fonctions.
Le but de cette quête est de commencer le PHP orienté objet. Vous allez voir dans cette quête les prémices du PHP Orienté Objet.
#### Objectifs
...
Première introduction sur la programmation orientée objet avec une première découverte et une présentation de la syntaxe d'écriture de classes.
...
![](images/001-les-classes-et-les-objets.png)

```resource
http://www.apprendre-php.com/tutoriels/tutoriel-29-les-classes-et-objets.html
# Pour aller plus loin sur les Classes et les Objets
...
```resource
https://www.youtube.com/watch?v=r_NiFqLvfsc&index=1&list=PLjwdMgw5TTLVDKy8ikf5Df5fnMqY-ec16
# Un combat de magicien pour tester les pouvoirs de l'objet
...
- Adresse
- Date de naissance
1. Créer une méthode pour afficher les infos de 'Personne' et une autre pour modifier l'adresse.
1. Crée une méthode qui calcule l'âge à partir de la date de naissance.
1. Pour soumettre ta solution, uploade le fichier dans un gist, puis poste le lien du gist.
