...
![Capture d'écran d'un navigateur avec un onglet entouré avec le titre de la page](images/001-capture-d-ecran-d-un-navigateur-avec-un-onglet.jpg)*Source:* [https://www.myprograming.com/html-head-tag/](https://www.myprograming.com/html-head-tag/)
...
![Capture d'écran d'un résultat de recherche google avec la description entouré en rouge](images/002-capture-d-ecran-d-un-resultat-de-recherche.webp)
...
![Capture d'écran de la fenêtre du navigateur avec deux onglets et une favicône entouré sur chaque onglet](images/003-capture-d-ecran-de-la-fenetre-du-navigateur.jpg)
