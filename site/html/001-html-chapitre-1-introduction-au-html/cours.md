...
![](images/001-qu-est-ce-que-le-html.png)
...
![Comparaison des éléments blocs et des éléments inline, les éléments blocs sont représentés comme des blocs prenants toute la largeur de l'écran tandis que les éléments inline s'affichent les uns à côté des autres](images/002-comparaison-des-elements-blocs-et-des-elements.jpg)
...
```html
<img src="images/003-les-balises-auto-fermantes.jpg" />
```
...
```html
<img src="images/003-les-balises-auto-fermantes.jpg" alt="A cute dog" />
```
...
<img src="images/003-les-balises-auto-fermantes.jpg" alt="A Cute dog" width="300" />
<button disabled>Click here</button>
```
