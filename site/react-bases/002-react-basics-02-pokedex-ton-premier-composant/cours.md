...
![interface utilisateur avec les composants mis en évidence](images/001-interface-utilisateur-avec-les-composants-mis.jpg)
...
![App contient des composants qui peuvent contenir leurs propres composants](images/002-app-contient-des-composants-qui-peuvent.png)
...
À l'intérieur de la balise `<figure>`, ajoute une balise `<img>` avec l'attribut `src` défini sur l'URL suivante : `images/003-bulbasaur.png`. Cette image représente le Pokémon "Bulbasaur".
