...
(function () {
  ...
  if (grilleThemes) {
    ...
    // Inseres DANS #grille-themes : la recherche plein texte masque ce bloc,
    // la barre de filtres et les favoris disparaissent donc avec lui.
    grilleThemes.insertBefore(panneau, grilleThemes.firstChild);
    ...
    grilleThemes.insertBefore(section, panneau.nextSibling);
