...
![](https://storage.googleapis.com/quest_editor_uploads/Qh9eioncagaCVRzTtokFTo9nwqDH5Jic.png)
...
[https://www.youtube.com/watch?v=5sLYAQS9sWQ](https://www.youtube.com/watch?v=5sLYAQS9sWQ)
...
1. [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/) : Cette ressource utilise des illustrations et un langage simple pour expliquer les mécanismes complexes de GPT.
2. [Attention is All You Need](https://arxiv.org/pdf/1706.03762.pdf) : Cet article original de Google présente le modèle transformer, qui est utilisé par GPT. Il s'agit d'une ressource très technique mais essentielle pour comprendre le cœur des modèles GPT.
...
- [Guide des modèles de chat d'OpenAI](https://platform.openai.com/docs/guides/chat/)
- [Comment fonctionne ChatGPT ?](https://zapier.com/blog/how-does-chatgpt-work/)
- [Ajustement fin des grands modèles de langage avec Hugging Face et DeepSpeed](https://www.databricks.com/blog/2023/03/20/fine-tuning-large-language-models-hugging-face-and-deepspeed.html)