...
![modules](https://storage.googleapis.com/quest_editor_uploads/5UI6CrajvEJGV3lfMTsgi5zT71yqILdy.png)
# Comprendre le concept de "query string"
![](https://storage.googleapis.com/quest_editor_uploads/ZGDitGIGY74hjdToPqrwCUMlMyWBFmdI.png)
```xtext story
...
![/api/programs/1 + /api/programs/:id => req.params.id = 1](https://storage.googleapis.com/quest_editor_uploads/YXnMmJmRI5mfxNdDpB44MBgSeESqdhqO.png)
