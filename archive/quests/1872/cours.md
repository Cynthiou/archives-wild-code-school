...
Dans cette quête, nous allons introduire le concept de Context API dans React. Comme il est indiqué dans la [documentation officielle](https://react.dev/learn/passing-data-deeply-with-context):
...
![image](https://images.unsplash.com/photo-1496152658208-d41635783718?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=967&q=80)
...
![image](https://res.cloudinary.com/dw4g9x8wv/image/upload/v1604065348/Screenshot_from_2020-10-30_13-40-56_r57i6d.png)
...
![image](https://res.cloudinary.com/dw4g9x8wv/image/upload/v1604065321/Screenshot_from_2020-10-30_13-41-10_adshzv.png)
