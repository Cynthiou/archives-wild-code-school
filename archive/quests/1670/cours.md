...
![Bravo](https://media.giphy.com/media/s2qXK8wAvkHTO/giphy.gif)
```spacer-medium
```
...
Ce qui donne comme résultat :![image](https://storage.googleapis.com/quest_editor_uploads/JG0Xz7z2eRQsihfGdJaeUFGvz4bUUKVo.png)
...
![image](https://storage.googleapis.com/quest_editor_uploads/gWQ0Cg422EOTVgJ7RSXQyx65mweRVwkV.jpg)
