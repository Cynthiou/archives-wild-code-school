...
![](https://storage.googleapis.com/quest_editor_uploads/UgW7sctJ2KfPPDjXgvmmEayKHoLgnBo7.png)
...
![plusieurs boutons mais 1 seul état](https://storage.googleapis.com/quest_editor_uploads/NziEvw7rA5VduKl2iP2HNqnEhBEwEILx.png)
...
![1 état pour chaque bouton](https://storage.googleapis.com/quest_editor_uploads/naQI2ocNtr4wbkN62gwj68cttbyeQwNf.png)
````
...
```html
<img src="https://picsum.photos/id/237/200/300" alt="chien trop mignon" />
```
