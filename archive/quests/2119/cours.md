...
![Illustration d'un élément HTML. Un élément HTML se compose d'un contenu situé entre deux balises](https://storage.googleapis.com/quest_editor_uploads/78ToCtBEFFgH6kIrfDR1PM3KlcJJrt8W.png)
````
